...
function Library:CreateWindow(...)
    ...
    function Library:Toggle()
        ...
        if Toggled then
            ...
            task.spawn(function()
                ...
                if(typeof(Cursor)~="table")then return; end
                Cursor.Thickness = 1;
                Cursor.Filled = true;
                Cursor.Visible = true;
    ...
    Library:GiveSignal(InputService.InputBegan:Connect(function(Input, Processed)
        ...
        elseif Input.KeyCode == Enum.KeyCode.RightControl or or Input.KeyCode.Name == "F5" or (Input.KeyCode == Enum.KeyCode.RightShift and (not Processed)) then
            task.spawn(Library.Toggle)
        end
    end))
